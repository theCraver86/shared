...
### - Load 
  ...
  date <- c(PW_start, PW_end);
    ...
    filter(Departure.Month %in% c("6-2023", "7-2023", "8-2023", "9-2023","10-2023", "11-2023", "12-2023"));
  ...
  ff_departureMonth_join <- ff_departureMonth_CW %>% 
    ...
    #select(-c(primaryCategory_CW, primaryCategory_PW, select_flight_PW, BCR_PW, BCR_CW, Orders_PW, Orders_CW))
  ...
  ff_departureMonth_join_pivot <- ff_departureMonth_join %>% 
   ...
   #select(c('Country', 'Route', 'revenue', 'select_flight', 'BCR', 'AOV', 'revenue_delta', 'select_flight_delta', 'BCR_delta', 'AOV_delta','6-2023', '7-2023', '8-2023', '9-2023', '10-2023', '11-2023', '12-2023'))
    select(c('Country', 'Route', 'revenue', 'select_flight', 'BCR', 'AOV', 'revenue_delta', 'select_flight_delta', 'BCR_delta', 'AOV_delta','6-2023', '7-2023', '8-2023', '9-2023', '10-2023', '11-2023'))

  write_xlsx(ff_departureMonth_CW, "C:/Users/rtadd/OneDrive/Desktop/R/1exported/ff_departureMonth_CW.xlsx")
  write_xlsx(ff_departureMonth_PW, "C:/Users/rtadd/OneDrive/Desktop/R/1exported/ff_departureMonth_PW.xlsx")
  write_xlsx(ff_departureMonth_join, "C:/Users/rtadd/OneDrive/Desktop/R/1exported/ff_departureMonth_join_2.xlsx")
  write_xlsx(ff_departureMonth_join_pivot, "C:/Users/rtadd/OneDrive/Desktop/R/1exported/ff_departureMonth_join_pivot_27_bis.xlsx")