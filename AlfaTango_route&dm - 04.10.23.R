...
ff_departureMonth_PW <- extract_df(date, dimensions, metrics, top, search) %>% 
  filter(Departure.Month %in% c("8-2023", "9-2023","10-2023", "11-2023", "12-2023", "1-2024", "2-2024", "3-2024", "4-2024", "5-2024")) %>% 
  mutate(Country = tolower(Country))
...
ff_departureMonth_slice <- ff_departureMonth_join_slice %>% 
  ...
  select(c('Country', 'Route', 'revenue', 'select_flight', 'BCR', 'AOV', 'revenue_delta', 'select_flight_delta', 'BCR_delta', 'AOV_delta', '10-2023', '11-2023', '12-2023', '1-2024', '2-2024', '3-2024', '4-2024', '5-2024'))
...
ff_departureMonth_full <- ff_departureMonth_join_full %>% 
  ...
  right_join(df_export, by=c('Country','Route')) %>% 
  select(c('Country', 'Route', 'revenue', 'select_flight', 'BCR', 'AOV', 'revenue_delta', 'select_flight_delta', 'BCR_delta', 'AOV_delta', '8-2023', '9-2023', '10-2023', '11-2023', '12-2023', '1-2024', '2-2024', '3-2024', '4-2024', '5-2024'))
...
##SLICE Departure Month - by Revenue
# ff_departureMonth_join_slice_revenue <- ff_departureMonth_CW %>%
#   left_join(ff_departureMonth_PW, by=c('Country','Route','Departure.Month'), suffix = c("_CW", "_PW")) %>%
#   rename(
#     select_flight_PW = XDM.e101...select.flight_PW,
#     select_flight_CW = XDM.e101...select.flight_CW
...
#   ) %>% 
#   right_join(df_export, by=c('Country','Route')) %>% 
#   select(c('Country', 'Route', 'revenue', 'select_flight', 'BCR', 'AOV', 'revenue_delta', 'select_flight_delta', 'BCR_delta', 'AOV_delta', '9-2023', '10-2023', '11-2023', '12-2023', '1-2024', '2-2024', '3-2024', '4-2024', '5-2024'))
# 
# 
# write_xlsx(ff_departureMonth_join_slice_revenue, "C:/Users/IT011820/OneDrive - ITA Italia Trasporto Aereo/Desktop/0. R/02_exported/ff_departureMonth_slice.xlsx")
